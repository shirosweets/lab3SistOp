...
La mejor forma que se nos ocurre de comparar eso es comparar a cuantos KFLO/TICK llega con un solo `cpubench` en cada uno, y a cuantos IO/TICK llega con un solo `iobench`  en cada uno, ambas cosas para *quantum* normal y para *quantum* 10 veces mas corto (para 100 veces más corto no lo tomamos en cuenta debido a la imprecisión de los datos).
